        ...
        <div class="page-container">
            ...
            <main class="main-card">
                <div class="form-header">
                    <h1>Tambah User</h1>
                    <p>Tambahkan akun baru untuk admin, staff pelayanan, atau teknisi.</p>
                </div>
                        ...
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" value="{{ old('name') }}" class="form-control"
                                    placeholder="Contoh: Staff Pelayanan" required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="kategori_teknisi" id="kategori_teknisi" class="form-control">
                                    <option value="">Pilih Kategori Teknisi</option>

                                    <option value="sistem"
                                        {{ old('kategori_teknisi') === 'sistem' ? 'selected' : '' }}>
                                        Teknisi Sistem / Software
                                    </option>

                                    <option value="barang"
                                        {{ old('kategori_teknisi') === 'barang' ? 'selected' : '' }}>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="unit_kerja" value="{{ old('unit_kerja') }}"
                                    class="form-control" placeholder="Contoh: Pelayanan">
                            </div>
